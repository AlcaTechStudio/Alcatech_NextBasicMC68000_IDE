...
_global_v_count equ $ff0004
; Auto Declaracao variavel -> sp1 = 1 
_global_sp1 equ $ff0006
; Auto Declaracao variavel -> sp2 = 2
_global_sp2 equ $ff0008
; Auto Declaracao variavel -> flag_vbl = 1
_global_flag_vbl equ $ff000a
...
;------------------------
    ...
    ;sp1 = 1 
    move.w #1,_global_sp1

    ;sp2 = 2
    move.w #2,_global_sp2

    ;set_sprite_size(sp1,3,3)
    move.w #3,-(a7)
    move.w #3,-(a7)
    move.w _global_sp1,-(a7)
    bsr set_sprite_size
    addq #6,a7
...
lbl_if_false_2:
    ...
    ; reset_sprite_priority() 'Reseta a ordem com que os sprites sao desenhados na tela
    bsr reset_sprite_priority
...
VDP_std_Reg_init:
    ...
    even
pal:
    dc.w $0000,$0222,$0244,$0666,$0444,$0246,$0668,$0002
    dc.w $0024,$0068,$0000,$0A20,$008A,$0E40,$000E,$00CE
    dc.w $0ECA,$0222,$0244,$0666,$0444,$0246,$0668,$0002
    dc.w $0024,$0068,$0000,$0A20,$008A,$0E00,$0E00,$00CE
    even
Ball:
    dc.l $00000000
    dc.l $00000000
