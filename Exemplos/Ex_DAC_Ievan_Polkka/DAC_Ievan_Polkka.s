...
lbl_for_2_start:
    ...
    ; draw_tile( peek(addressof(map_A) + ((x + (y*40))*2) as word) + 1, x,y, 0)
    move.w #0,-(a7)
    move.w _global_y,-(a7)
    move.w _global_x,-(a7)
    moveq #0,d0
...
lbl_for_4_start:
    ...
    ; draw_tile( (peek(addressof(map_B) + ((x + (y*40))*2) as word) or 1<<13 )+ 1, x,y, 1)
    move.w #1,-(a7)
    move.w _global_y,-(a7)
    move.w _global_x,-(a7)
    moveq #0,d0
...
lbl_while_false_3:
    ...
    ; poke(peek(addressof(wave)+k as byte) as byte,&hA04001) ' Le o proximo Byte e envia para o DAC
    lea $A04001,a0
    move.l #wave,d0
    add.l _global_k,d0
    move.l d0,a1
...
@vb_in_pg:
    ...
    even
wave:
    incbin "C:\Users\Alca_Tech\Desktop\NEXTBasic_Build_18_12_2020\Exemplos\Ex_DAC_Ievan_Polkka\ievan_polkka.bin" 
wave_end:

    ;imports "\tile_data.bin" '1338 tiles
    even
tiles:
    incbin "C:\Users\Alca_Tech\Desktop\NEXTBasic_Build_18_12_2020\Exemplos\Ex_DAC_Ievan_Polkka\tile_data.bin" 

    ;imports "\tile_mapA.bin"
    even
map_A:
    incbin "C:\Users\Alca_Tech\Desktop\NEXTBasic_Build_18_12_2020\Exemplos\Ex_DAC_Ievan_Polkka\tile_mapa.bin" 

    ;imports "\tile_mapB.bin"
    even
map_B:
    incbin "C:\Users\Alca_Tech\Desktop\NEXTBasic_Build_18_12_2020\Exemplos\Ex_DAC_Ievan_Polkka\tile_mapb.bin" 
    even
VDP_std_Reg_init:
    dc.b $04
    dc.b $74
    ...
    even
paleta:
    dc.w $0000,$0000,$0222,$0002,$0224,$0026,$0422,$0226
    dc.w $0248,$0444,$024C,$0446,$0668,$068A,$0888,$066C
    dc.w $0000,$046A,$0468,$048E,$08AC,$0644,$0AA8,$0864
    dc.w $0866,$0AAC,$0EEE,$04AE,$06AE,$08CE,$04CE,$0A64
    even    
isr_01_vector:
    rte
isr_02_vector:
