...
_global__v_fixed equ $ff0004
;dim _v_int   as integer = 77               'Declara uma variavel Inteira
_global__v_int equ $ff0006
;dim _v_sig   as signed integer = -385      'Declara uma variavel inteira Signed
_global__v_sig equ $ff0008
;dim _str_    as string = "-- NEXTBasic --" 'Declara um String Constante e salva o Endereco na variavel _str_
_global__str_ equ $ff000a
...
_global__print_cursor equ $ff0628
;dim _print_plane  as integer
_global__print_plane equ $ff062a
;dim _print_pallet as integer
_global__print_pallet equ $ff062c
...
;------------------------
    ...
    ;std_init()   'Inicializa o VDP com a configuracao padrao
    bsr std_init

    ;print_init() 'Inicializa a Biblioteca print e carrega a fonte no endereco 0 ~ 255 da Vram
    bsr print_init
    move.w #(2248),_global__v_fixed
    move.w #77,_global__v_int
    move.w #-385,_global__v_sig
    move.l #const_string_0_,_global__str_

    ;println(_str_) : println("")
    move.l _global__str_,-(a7)
    bsr println
    addq #4,a7
