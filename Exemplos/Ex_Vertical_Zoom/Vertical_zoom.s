...
; Auto Declaracao variavel -> for y = 0 to 14
_global_y equ $ff0004
; Auto Declaracao variavel ->  for x = 0 to 15
_global_x equ $ff0006
; Auto Declaracao variavel -> camZ = 0 ' Variavel que controla o Scaling
_global_camZ equ $ff0008
; Auto Declaracao variavel -> j = joypad6b_read(0) ' Le o Joystick 1
...
lbl_for_1_end:
    ...
    move.w #0,_global_camZ

    ;Enable_H_int()  ' Ativa Interrupcao horizontal
    bsr Enable_H_int

    ;set_hint_counter(0) ' Interrupcao vai ocorrer em todas as scanlines
    move.w #0,-(a7)
    bsr set_hint_counter
    addq #2,a7
...
lbl_do_1_start:
    ...
    ;j = joypad6b_read(0) ' Le o Joystick 1
    move.w #0,-(a7)
    bsr joypad6b_read
    addq #2,a7
    move.w d7,_global_j
...
lbl_elseif_true_2:
    ...
    ; camZ-=1
    moveq #1,d0
    sub.w d0,_global_camZ
    bra lbl_if_end_1
lbl_elseif_false_2:
lbl_if_end_1:

    ;if  _signed(camZ <= - 194) then
    move.w _global_camZ,d0
    cmp.w #-194,d0
    sle d0
    and.w #$01,d0
...
lbl_if_true_3:
    ...
    ; camZ = -194
    move.w #-194,_global_camZ
    bra lbl_if_end_3
lbl_if_false_3:

    ;elseif _signed(camZ>= 576) then 'E necessario usar _signed nesse caso, pois nossa variavel pode assumir valores negativos
    move.w _global_camZ,d0
    cmp.w #576,d0
    sge d0
    and.w #$FF,d0
...
lbl_do_1_end:
    ...
    ;sub isr_06_vector() ' Interrupcao Vertical
isr_06_vector:

    ;vb_flag = 0 ' Limpa o Flag de interrupcao Vertical (marca o inicio do proximo frame)
    ...
    ;sub isr_04_vector() ' Interrupcao Horizontal (scaling no Plano A)
isr_04_vector:
    move.l d0,-(a7)
...
VDP_std_Reg_init:
    ...
    even
paleta:
    dc.w $0000,$0000,$0644,$0244,$028C,$0A66,$0C88,$0004
    dc.w $0CEE,$0008,$000C,$0268,$0246,$0000,$0000,$0000
    even    
isr_01_vector:
    rte
isr_02_vector:
