...
lbl_elseif_false_2:
    ...
    ;  dir = 0
    move.w #0,_global_dir
lbl_if_end_1:

    ;  x+=dir
    move.w _global_dir,d0
    add.w d0,_global_x
...
lbl_for_3_start:
    ...
    ;  Hscroll_strip8((i*(x>>4))+offset,i,0)
    move.w #0,-(a7)
    move.w _global_i,-(a7)
    move.w _global_x,d0
    lsr.w #4,d0
    mulu _global_i,d0
    add.w _global_offset,d0
    move.w d0,-(a7)
    bsr Hscroll_strip8
    addq #6,a7
    moveq #1,d0
...
@vb_in_pg:
    ...
    even
mapa:
    incbin "C:\Users\Alca_Tech\Desktop\NEXTBasic_Build_18_12_2020\Exemplos\Ex_Scroll_strips\mapa.bin" 

    ;imports"\tiles.bin"
    even
tiles:
    incbin "C:\Users\Alca_Tech\Desktop\NEXTBasic_Build_18_12_2020\Exemplos\Ex_Scroll_strips\tiles.bin" 
    even
VDP_std_Reg_init:
    dc.b $04
    dc.b $74
